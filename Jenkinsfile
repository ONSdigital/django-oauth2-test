    ...
    stages {
        ...
        stage('dev') {
            ...
            steps {
                ...
                sh 'cf push --no-start ras-django-dev'
                sh 'cf set-env ras-django-dev SECRET_KEY {env.OAUTH_SECRET_KEY}'
                sh 'cf start ras-django-dev'
            }
        }
        ...
        stage('release') {
            ...
            steps {
                ...
                sh "git remote set-url origin https://ons-sdc:${GITHUB_API_KEY}@github.com/ONSdigital/django-oauth2-test.git"
